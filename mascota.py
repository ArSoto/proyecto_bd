        ...
        if (data != self.data):
            ...
            for i in data:
                self.treeview.insert("", "end", text=i[0],
                                     values=(i[1] + " " + i[2] + " " + i[3].replace(" ", "\\ " )  + " " + i[4].replace(" ", "\\ " )
...
class insertar:
    ...
    def __config_label(self):#id, nombre, especie, dueño, descripcion, fecha
        ...
        tk.Label(self.insert_datos, text="Descripcion: ").place(x=10, y=100, width=150, height=20)
    ...
    def __config_entry(self):
        ...
        self.combo_especie["values"], self.ids = self.__fill_combo_especie()
        self.combo_dueno = ttk.Combobox(self.insert_datos)
        self.combo_dueno.place(x=160, y=70, width=200, height=20)
        self.combo_dueno["values"], self.ids = self.__fill_combo_dueno()
    ...
    def __insertar(self):  # Insercion en la base de datos.
        ...
        self.db.run_sql(sql, {"nom_mascota": self.entry_nombre.get(), "id_especie": self.combo_especie.current(),
                              "id_dueno": self.combo_dueno.current(), "descrip_masc": self.entry_descripcion.get(),
